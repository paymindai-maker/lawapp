...
export function toCategoryFormValues(cat: ServiceCategoryDoc): CategoryFormValues {
    ...
    <form onSubmit={handleSubmit(onSave)} className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 gap-2">
          ...
          <SaveButton label={initialData ? "Save changes" : "Add category"} />
        </div>
      </div>

      <div className="max-w-2xl rounded-lg border bg-card p-6 space-y-5">
        <Field label="Name" error={errors.name?.message}>
          <Input placeholder="Business Registration" {...register("name")} />
        </Field>
